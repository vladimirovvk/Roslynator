...
namespace Roslynator.CSharp.Refactorings
{
    internal static class LocalFunctionStatementRefactoring
    {
        public static async Task ComputeRefactoringsAsync(RefactoringContext context, LocalFunctionStatementSyntax localFunctionStatement)
        {
            ...
            {
                if (context.IsRefactoringEnabled(RefactoringDescriptors.MoveLocalFunction)
                    ...
                    && localFunctionStatement.IsParentKind(SyntaxKind.Block)
                    && CSharpFacts.CanHaveBody(localFunctionStatement.Parent.Parent.Kind())
                    && !localFunctionStatement.ContainsUnbalancedIfElseDirectives())
                {
